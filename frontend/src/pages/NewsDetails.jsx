      ...
      <Row>
        ...
        <Col md={6}>
          <div className="article-details">
            ...
            {/* Displaying article content with lists */}
            <div className="content fs-5">
              {/* Split content by new line to detect where lists should be inserted */}
              {article.content.split("\n").map((paragraph, index) =>
                paragraph.trim().startsWith("1. ") ||
                paragraph.trim().startsWith("• ") ? (
                  <ul className="list-unstyled mb-4" key={index}>
                    {paragraph.split("\n").map((item, idx) => (
